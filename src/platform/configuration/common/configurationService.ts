...
export namespace ConfigKey {
	...
	*/
	export namespace Internal {
		...
		export const InlineEditsEnableCompletionsProvider = defineExpSetting<boolean>('chat.advanced.inlineEdits.completionsProvider.enabled', true, INTERNAL_RESTRICTED);
